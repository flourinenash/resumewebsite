...
<body>
    <section id="header">
        ...
        <nav id="nav">
            <ul>
                <li><a href="#one" class="active">About Me</a>
                </li>
        ...
        <footer>
            <ul class="icons">
                <li><a href="https://www.linkedin.com/in/flourinenash/" class="icon fa-linkedin"><span class="label">Twitter</span></a>
                </li>
                <li><a href="tel:520-273-0365" class="icon fa-phone"><span class="label">Phone</span></a>
                </li>
                <li><a href="/downloads/Dheeraj_Gupta.vcf" style="border:0;"><img src="images/Asset_1.png" alt="vCard Download" class="nolinecard" style="border:0;"></a>
                </li>
                ...
                <div class="container">
                    ...
                    <div class="features">
                        <article>
                            ...
                            <div class="inner">
                                <h4 align="center">Cyber Security Consultant</h4>
                                <h5 align="center"> Starting July 2017 &nbsp;&nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;Newport Beach, CA</h5>
            ...
            <section id="seven">
                <div class="container">
                    ...
                    <form name="myForm" action="mail.php" onsubmit="return validateForm()" method="POST">
                        ...
                        <div class="row uniform">
                            <div class="12u">
                                <div class="g-recaptcha" data-sitekey="6Ld1sTIUAAAAAMfwQR6JerC74hBQSoYpu9AjQe7J"></div>
                            </div>
                        </div>
    ...
    <script>
        function validateForm() {
            ...
            if ( name == "" ) {
                text = text + "Error: Name must be filled out";
                document.getElementById( "demo" ).innerHTML = text;
            }

            if ( name.length < 5 ) {
                text = text + "<br>Error: Please enter your last name";
                document.getElementById( "demo" ).innerHTML = text;
            }
            ...
            if ( !filter.test( email ) ) {
                text = text + "<br>Error: Please enter a valid email";
                document.getElementById( "demo" ).innerHTML = text;
            }

            var subject = document.forms[ "myForm" ][ "subject" ].value;
            if ( subject.length < 1 ) {
                text = text + "<br>Error: Subject must be filled out";
                document.getElementById( "demo" ).innerHTML = text;
            }
            ...
            if ( !googleResponse ) {
                text = text + "<br>Error: Please verify you are a human";
                document.getElementById( "demo" ).innerHTML = text;
            }
